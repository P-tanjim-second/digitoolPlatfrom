    ...
    return (
        <div className=' mx-auto mt-28 py-28 text-center flex flex-col justify-center items-center space-y-5 bg-[#f9fafc]'>
            ...
            <div className='flex flex-wrap gap-5 justify-center relative'>
                <div className='rounded-lg shadow-sm flex flex-col items-center justify-center gap-2 relative w-95 h-95'>
                ...
                <div className='rounded-lg shadow-sm flex flex-col items-center justify-center gap-2  w-95 h-95 relative'>
