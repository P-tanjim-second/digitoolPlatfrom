    ...
    return (
        <div className=' mx-auto mt-28 py-28 text-center flex flex-col justify-center items-center space-y-5 bg-[#f9fafc]'>
            ...
            <div className='flex flex-wrap gap-5 justify-center relative'>
                <div className='rounded-lg scale-[0.9] lg:scale-100 shadow-sm flex flex-col items-center justify-center gap-2 bg-white relative w-95 h-95 cartRevelScroll' style={{ animationRange: `entry ${10 + 1 * 12}% cover 30%`}}>
                ...
                <div className='rounded-lg scale-[0.9] lg:scale-100  bg-white shadow-sm flex flex-col items-center justify-center gap-2  w-95 h-95 relative cartRevelScroll' style={{ animationRange: `entry ${10 + 2 * 12}% cover 30%`}}>
                ...
                <div className='rounded-lg scale-[0.9] lg:scale-100  bg-white shadow-sm flex flex-col items-center justify-center gap-2  w-95 h-95 relative cartRevelScroll' style={{ animationRange: `entry ${10 + 3 * 12}% cover 30%`}}>
